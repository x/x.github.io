---
layout: post
title: Pong in JavaScript Part I
date: 2013-10-22 22:06:31.000000000 -04:00
---
_This post is part one of a two part series. Find part two [here](http://blog.peticol.as/pong-in-javascript-part-ii/) and complete code at [github.com/x/Game-Development-in-Javascript-Tutorial](http://github.com/x/Game-Development-in-Javascript-Tutorial)._

_If you find any bugs in my code or grammar, please make a pull request [on the source code](http://github.com/x/Game-Development-in-Javascript-Tutorial)._

---

_JavaScript is the language of the web. There are more JavaScript interpreters being used every day than any other language (you're using one right now). The goal of this peice is to introduce the reader JavaScript the language and show how to, with an HTML5 Canvas element, create a simple game. It is targeted twords readers who have never been exposed to JavaScript, but understand the basics of programming._
...
The ```word.length``` clearly returns a number, but instead of declaring length as an int we declared it as a var (as in variable).
...
_Keep reading in [part two](http://blog.peticol.as/pong-in-javascript-part-ii/) of this tutorial!_
